...
import zipfile
import numpy as np
from keras.layers import Layer, LSTM, Dense, Input, Bidirectional # Keras is the most friendly Neural Network library, this Kernel use a lot of layers classes
from keras.models import Model
from tqdm import tqdm # Processing time measurement
from sklearn.model_selection import train_test_split 
from keras import backend as K # The backend give us access to tensorflow operations and allow us to create the Attention class
from keras import optimizers, initializers, regularizers, constraints # Allow us to access the Adam class to modify some parameters
from sklearn.model_selection import GridSearchCV, StratifiedKFold # Used to use Kfold to train our model
from keras.callbacks import ModelCheckpoint # This object helps the model to train in a smarter way, avoiding overfitting
#Obtaining competition data
os.system('kaggle competitions download -c vsb-power-line-fault-detection')
arch_zip = zipfile.ZipFile('vsb-power-line-fault-detection.zip')
print('Extracting.')
arch_zip.extractall('.')
print('Extracting done.')
arch_zip.close()
os.remove('vsb-power-line-fault-detection.zip')
